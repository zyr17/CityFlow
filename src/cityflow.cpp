...
PYBIND11_MODULE(cityflow, m) {
    py::class_<CityFlow::Engine>(m, "Engine")
        ...
        .def("get_roadlink_vehicle_count", &CityFlow::Engine::getRoadLinkVehicleCount, "intersection_id"_a, "roadlink_index"_a)
        .def("get_roadlink_waiting_vehicle_count", &CityFlow::Engine::getRoadLinkWaitingVehicleCount, "intersection_id"_a, "roadlink_index"_a)
		...
		.def("get_road_average_delay", &CityFlow::Engine::getRoadAverageDelay)
        ...
        .def("set_lane_direction", &CityFlow::Engine::setLaneDirection, "lane"_a, "direction"_a)
